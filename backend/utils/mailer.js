...
const htmlTemplate = `
      ...
      <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; text-align: center; padding: 40px 0;">
        <div style="background-color: #f4f5f6; border-radius: 8px; padding: 40px 30px; display: block; width: 100%; box-sizing: border-box;">
          <div style="color: #5a4bda; font-size: 30px; font-weight: bold; line-height: 1.5; letter-spacing: 1px;">
            ${otp}
          </div>
        </div>
