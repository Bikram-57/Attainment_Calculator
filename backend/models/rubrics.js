...
// // 3. Database Indexes
// // This ensures we can have ONE rubric for BCA 2024, and ONE for MCA 2024.
// rubricSchema.index({ course: 1, year: 1 }, { unique: true });

// const Rubric = mongoose.model('Rubric', rubricSchema);

// // THE MAGIC FIX: This forces MongoDB to delete old, conflicting unique indexes 
// // (e.g., if you used to have a unique rule on JUST the year)
// Rubric.syncIndexes().then(() => {
//     console.log("✅ Rubric Indexes Synced successfully.");
// }).catch(err => {
//     console.error("❌ Error syncing Rubric indexes:", err);
// });
