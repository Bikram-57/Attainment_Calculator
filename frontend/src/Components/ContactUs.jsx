...
function ContactUs() {
    ...
    return (
        ...
        //                         <div className="w-16 h-16 rounded-full bg-gradient-to-r from-cyan-400 to-purple-500 flex items-center justify-center text-2xl font-bold text-white">
        //                             {person.name
        //                                 .split(" ")
        //                                 .map(word => word[0])
        //                                 .join("")}
        ...
        //                         <a
        //                             href={`mailto:${person.email}`}
        //                             className="px-4 py-2 rounded-full bg-red-500/20 text-red-300 hover:bg-red-500/30 transition"
        //                         >
        //                             Email
        //                         </a>
        ...
        //                             target="_blank"
        //                             rel="noopener noreferrer"
        //                             className="px-4 py-2 rounded-full bg-blue-500/20 text-blue-300 hover:bg-blue-500/30 transition"
        //                         >
        //                             LinkedIn
        //                         </a>
        ...
        //                             target="_blank"
        //                             rel="noopener noreferrer"
        //                             className="px-4 py-2 rounded-full bg-gray-500/20 text-gray-300 hover:bg-gray-500/30 transition"
        //                         >
        //                             GitHub
        //                         </a>
        //                     </div>
