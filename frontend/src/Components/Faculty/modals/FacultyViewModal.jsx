...
function FacultyViewModal({ data, closeMenu }) {
	return (
		...
		>
			<div
				className="w-full max-w-lg rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden"
			...
			>
				...
				<div className="px-4 sm:px-6 py-5 sm:py-6">
					...
					<div className="grid grid-cols-1 sm:grid-cols-[150px_1fr] gap-y-3 sm:gap-y-5 gap-x-8 text-sm sm:text-lg">
